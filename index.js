var crudApp = new function () {
    ...
    this.myBooks = [
        { ID: '1', Subject: 'Computers Architecture', Room: '123', Time: 10 , Instructor: 'Mrs_hanna'},
        { ID: '2', Subject: 'Programming', Room: '456', Time: 8, Instructor: 'Mr_daryl' },
        { ID: '3', Subject: 'Science Architecture', Room: '789', Time: 9 , Instructor: 'Dr_prof'},
    ]

    this.category = ['111', '125', '665','322'];
    this.col = [];
